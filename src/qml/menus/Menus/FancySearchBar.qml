        ...
        Item {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    anchors.margins: 12 * Base.PinterestGlobals.density
                    radius: 8 * Base.PinterestGlobals.density
                    color: "#000"
                    opacity: 0.2
                }
                ...
                TextInput {
                    ...
                    anchors.margins: 10 * Base.PinterestGlobals.density
        ...
        Item {
            ...
            Item {
                ...
                Rectangle {
                    id: searchHighlight
                    anchors.fill: parent
                    anchors.margins: item.opened? 18 * Base.PinterestGlobals.density : 8 * Base.PinterestGlobals.density
                    radius: item.opened? searchbarArea.radius : 4 * Base.PinterestGlobals.density
